 ...
 */
package com.cpjit.swagger4j.util.matcher;
...
import com.cpjit.swagger4j.util.Assert;
...
public final class AntPathRequestMatcher
	...
	public AntPathRequestMatcher(String pattern, String httpMethod,
		...
		this.httpMethod = StringUtils.isNotBlank(httpMethod) ? HttpMethod.valueOf(httpMethod)
				: null;
	...
	public boolean matches(HttpServletRequest request) {
		if (this.httpMethod != null && StringUtils.isNotBlank(request.getMethod())
